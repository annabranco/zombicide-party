...
export const RESISTED_ONE = 'Resisted one attack';
export const SELECT_DAMAGE = 'Select character and slot to inflict damage';
export const SELECT_TRADE_PARTNER = 'Select character to trade with';
